class PostsController < ApplicationController
  ...
  def post_title_params
    params.require(:post_title).permit(:title_name, :genre_id, :rate, :spoiler, :content, :title_id).merge(user_id: current_user.id)
  end

  def post_params
    params.require(:post).permit(:genre_id, :rate, :spoiler, :content).merge(user_id: current_user.id)
  end
